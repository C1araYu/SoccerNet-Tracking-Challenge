...
if __name__ == "__main__":
	...
	# 	seqName = "SNMOT-060",
	# 	FilePath ="dataset/train/SNMOT-060/gt/gt.txt",
	# 	image_dir = "dataset/train/SNMOT-060/img1",
	# 	mode = "gt",
	# 	output_dir  = "vid")
	...
	visualizer = MOTVisualizer(
		seqName = "SNMOT-116-CORRECT",
		# FilePath ="/home/eaw2233/DL_Assisted_Referee/ByteTrack_HOME/YOLOX_outputs/yolox_x_soccernet_no_gt/track_vis/SNMOT-116.txt",
		FilePath ="tracking-2023/test/SNMOT-116/gt/gt.txt",
		image_dir = "tracking-2023/test/SNMOT-116/img1",
		mode = "gt",
		output_dir  = "baseline_output_vid")
